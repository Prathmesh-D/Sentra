    ...
    <SidebarMenu>
      <SidebarMenuItem>
        ...
        <div className="flex flex-col gap-0 group-data-[collapsible=icon]:hidden transition-all duration-500">
          {/* User Card */}
          <div className="relative mx-3 mb-3 p-4 bg-gradient-to-br from-[#a3f2fb] via-[#a3f2fb] to-[#a3f2fb] rounded-xl shadow-[0_8px_30px_rgb(0,0,0,0.12)] hover:shadow-[0_12px_40px_rgb(0,0,0,0.18)] overflow-hidden transition-all duration-300 animate-float">
              ...
              <div className="flex items-center gap-3 mb-4">
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex items-center gap-2 mb-1">
                    <h3 className="font-bold text-[#084d45] truncate text-base leading-tight">
                      {user.name}
                    </h3>
                    {isDemo && (
                      <span className="px-1.5 py-0.5 rounded-full bg-amber-100 text-amber-800 text-[10px] font-bold tracking-wide">DEMO</span>
                    )}
                  </div>
          ...
          <div className="bg-white dark:bg-gray-900 rounded-lg shadow-xl p-6 w-full max-w-sm">
            ...
            <div className="flex justify-end gap-3">
              ...
              <button
                ...
                disabled={isLoggingOut}
                className="px-4 py-2 rounded-md bg-red-600 text-white hover:bg-red-700 disabled:opacity-60 disabled:cursor-not-allowed min-w-[100px]"
