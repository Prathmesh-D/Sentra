...
2. Look for `sentra-backend.jar`

3. Open PowerShell in that folder and run:
   ```powershell
   java -jar .\sentra-backend.jar
   ```
...
**Fix**:
- Rebuild the installer with updated build settings
- Ensure .env is included in the packaged resources
...
2. Start the app and confirm backend health at http://127.0.0.1:5000/api/health
...
### Recommended: Use Health Check Endpoint
- Check http://127.0.0.1:5000/api/health before showing login
